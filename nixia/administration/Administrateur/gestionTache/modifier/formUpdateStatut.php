    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper" style="background-color:#f0f0f2;">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                ...
                <h2 class="fs-2 m-0 primary-text">Ajout d'un e-mail à la base de donnée</h2>
                </div>
            ...
            <form action="modifStatut.php" method="POST" style="width:50%;margin:auto;margin-top:5%;border:1px solid #000;border-radius:25px; padding:25px;">
                ...
                <div class="mb-3">
                    ...
                    <select name="employe" class="form-select">
                        <option value="<?php echo $_GET['idEmploye']?>"><?php echo $_GET['nomEmploye']?></option>						
                ...
                <div class="mb-3">
                    ...
                    <select name="idStatut" class="form-select">
                        ...
                        <?php
							...
							$req = "SELECT * from statut where id=3 or id=4 or id=2;";
							$res = $bd->query($req);
