...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper" style="background-color:#f0f0f2;">
            ...
            <section>
            <form action="ajoutMailBD.php" method="POST" style="width:50%;margin:auto;margin-top:5%;border:1px solid #000;border-radius:25px; padding:25px;">
                ...
                <div class="mb-3">
                    ...
                    <select name="employe" class="form-select">
                        ...
                        <?php
							...
							$req = "SELECT id, nom, prenom FROM user where idRole='Emp';";
							$res = $bd->query($req);
