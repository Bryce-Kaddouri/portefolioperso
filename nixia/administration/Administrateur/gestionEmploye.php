    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><a style="text-decoration: none; color:#009d63;" href="/AP4-28032022v1/MS2R 03032022/administration/dashboard.php"><i
            ...
            <a href="dashboardAdministrateur.php" class="list-group-item list-group-item-action bg-transparent second-text "><i
                ...
                <a href="gestionEmploye.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
        ...
        <div id="page-content-wrapper" style="background-color:#f0f0f2;">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 primary-text">Gestion des employés</h2>
                </div>
                ...
                <table method="GET" style='margin: 2em;font-family: Helvetica, Arial, sans-serif;background: #ffffff;border-radius: 10px;box-shadow: 2px 2px 2px #ccc;overflow: hidden;'>
                    <thead> 
                        <tr>
                            ...
                            <th style='text-align:center;border-bottom:1px solid #000;border-right:1px solid #000;height:40px;'>Nom</th>
                            <th style='text-align:center;border-bottom:1px solid #000;border-right:1px solid #000;height:40px;'>Prenom</th>
                            <th style='text-align:center;border-bottom:1px solid #000;border-right:1px solid #000;height:40px;'>E-mail</th>
                            <th style='text-align:center;border-bottom:1px solid #000;border-right:1px solid #000;height:40px;'>Rôle</th>
                            <th style='text-align:center;border-bottom:1px solid #000;height:40px;'>Ajouter</th>
			        ...
			        $sql = "SELECT nom, prenom, email, libelle FROM user INNER JOIN role  ON user.idRole=role.id where idRole='Emp';"; // requete Pour afficher tous les membres de la listes
			        ...
			        while ($ligne = $res->fetch())  // on fait une boucle pour parcourir toutes les lignes de la table résultat obtenu avec $sql
			        {
                        ...
                        "<tr>
                            ...
                            <td style='width:10%;text-align:center; border-top:1px solid #000;'><a href='gestionEmploye/ajouter/formEmploye.php'><img class='img_bouton'src='circle-plus-solid.svg'></a></td>
                        </tr>";
			        }
		            ?> 
                </table>
