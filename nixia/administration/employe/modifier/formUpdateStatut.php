...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <!-- Page Content -->
        <div id="page-content-wrapper" style="background-color:#dbfcff;" >
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    <i class="fas fa-align-left primary-text fs-4 me-3" id="menu-toggle"></i>
                <h2 class="fs-2 m-0">Ajout d'une tache à la Base de donnée</h2>
                </div>
            ...
            <section>
            <form action="modifStatut.php" method="POST" style="width:50%;margin:auto;margin-top:5%;border:1px solid #000;border-radius:25px; padding:25px;">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="expediteur" value="<?php echo $_GET['client'];?>">
                </div>
                <div class="mb-3" hidden>
                    <label for="client" class="form-label">Client : </label>
                    <input type="text" class="form-control" name="employe" value="<?php echo $_GET['idEmploye'];?>">
                </div>
                <div class="mb-3">
                    ...
                    <select name="idStatut" class="form-select">
                        ...
                        <?php
							...
							$req = "SELECT * from statut where id=3 or id=4;";
							$res = $bd->query($req);
                ...
                <div class="mb-3">
                    <label for="expediteur" class="form-label">date de Reception :</label>
